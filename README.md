...
# Seed demo data (72 menu items, demo users, today's slots)
# Note: seed_data currently seeds the original 15 items; update seed_data.py to match fixtures.js for full 72
...
- Push notifications (FCM/APNs) for ready orders
- Analytics heatmap of peak ordering times
- Order rating / feedback system
- Multiple canteen locations
- Loyalty points / rewards
- UPI deep-links alongside Razorpay
- Sync 72-item mock menu to Django `seed_data` management command
